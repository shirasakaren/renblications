...
export function AppearanceSettings({ initialAppearance }: { initialAppearance: AppearanceValue }) {
  ...
  function update(next: AppearanceValue) {
    setAppearance(next);
    preview(next.themeId, next.mode, next.motionLevel);
  }
